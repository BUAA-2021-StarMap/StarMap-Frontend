      ...
      <div id="title">
        ...
        <el-dropdown @command="orderIndex" split-button class="right" size="small">
          ...
          <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="7">按pullRequests数量正序</el-dropdown-item>
              <el-dropdown-item command="8">按pullRequests数量倒序</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>        
      </div>
    ...
    data() {
      return {
        ...
        UserList:[
          {
            // 这个是默认的占位数据，不要注释掉
            AVATAR_URL: "https://portrait.gitee.com/uploads/avatars/user/450/1352340_zhaojh329_1578949560.png",
            COMMITS_COUNT: 0,
    ...
    methods: {
      ...
      searchUsers(tag){
        if (this.orderItem !== "default" && this.orderType !== "default") {
          ...
          this.$axios({
            method: 'post',
            url: 'http://101.42.224.73:8000/ranking/',
            data: {
...
<style scoped>
  ...
  */
  ...
  .box-card h1{ /* 这里实际上就是控制子元素 .addtional .general 下的h1 */
    text-align: center;
    font-size: 4vh;
  }
  /* 显示更多信息的弹出框的样式 */
